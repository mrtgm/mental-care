import { getMoodBasedColors } from "../domains/events/domain";
      ...
      <div className="flex items-center gap-3 text-sm text-gray-700">
        <div className="flex gap-1.5">
          {[20, 40, 60, 80, 100].map((percentage) => (
            <div key={percentage} className="w-4 h-4" style={{ backgroundColor: getMoodBasedColors(percentage).backgroundColor }}></div>
          ))}
        </div>
      </div>
    </div>
