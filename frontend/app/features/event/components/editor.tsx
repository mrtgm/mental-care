...
export const EventDetialEditor = ({
	isDrawerOpen,
	setIsDrawerOpen,
}: {
		...
		<Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
			<DrawerContent className="h-full max-h-[90vh] overflow-y-auto">
				<div className="mx-auto w-full max-w-sm">
					<DrawerHeader>
						<DrawerTitle>
							{calenderStore.selectedGridDay
								? `${calenderStore.selectedGridDay.day.year}/${calenderStore.selectedGridDay.day.month}/${calenderStore.selectedGridDay.day.date}`
								: "日付を編集"}
						</DrawerTitle>
					</DrawerHeader>
